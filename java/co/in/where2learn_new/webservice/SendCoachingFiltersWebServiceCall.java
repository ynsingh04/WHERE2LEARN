...
public class SendCoachingFiltersWebServiceCall {
	...
	public void sendCoachingFilters(Activity activityParam, String city,
			String area, String classes, String board, String subject)
			throws Exception {

		this.activity = activityParam;

		SendCoachingFiltersWebServiceCall.city = city;
		SendCoachingFiltersWebServiceCall.area = area;
		SendCoachingFiltersWebServiceCall.classes = classes;
		SendCoachingFiltersWebServiceCall.board = board;
		SendCoachingFiltersWebServiceCall.subject = subject;
...
//					activity.finish();
	...
	public synchronized void callWebService() throws Exception {
		...
		String URI = AppConfig.URI_POSTCOACHINGSEARCH + "?city=" + URLEncoder.encode(city, "UTF-8")
				+ "&Area=" + URLEncoder.encode(area, "UTF-8")
				+ "&Class=" + URLEncoder.encode(classes, "UTF-8")
...
//		AppConfig.CURRENTRANGE += AppConfig.LISTRANGE;
	...
	public void loadCoachingFilters(CoachinglListActivity coachinglListActivityParam) {

		this.coachinglListActivity = coachinglListActivityParam;

		ringProgressDialog = ProgressDialog.show(coachinglListActivity, "Please wait ...",
		...
		ringProgressDialog.setOnDismissListener(new OnDismissListener() {
			...
			public void onDismiss(DialogInterface dialog) {
				...
				if (isError) {
					...
					coachinglListActivity.initListView();
				}
