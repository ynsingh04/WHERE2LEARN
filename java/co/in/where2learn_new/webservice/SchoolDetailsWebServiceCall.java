...
import co.in.where2learn_new.detailspage.SchoolDetailsActivity;

public class SchoolDetailsWebServiceCall {
	...
	public SchoolDetailsWebServiceCall(String classified_id) {
...
//					callImageGalleriesSearchService();
	...
	protected void callImportantDates() throws ClientProtocolException,
			IOException, JSONException {

		String URI = AppConfig.URI_GETIMPORTANTDATESSEARCH + "?id="
				+ classified_id;
		...
		parseImportantDatesXML(result);

	}

	private void parseImportantDatesXML(Object result) throws JSONException {
		...
		for (int i = 0; i < cast.length(); i++) {
			...
			important_dates += (i + 1) + ". " + item.getString("Title") + "\n";

			Log.i(TAG, important_dates);

		}

		classifiedDetails.put("important_dates", important_dates);
