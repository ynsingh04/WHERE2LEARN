...
import co.in.where2learn_new.detailspage.CoachingDetailsActivity;

public class CoachingDetailsWebServiceCall {
	...
	public CoachingDetailsWebServiceCall(String classified_id) {
