...
import co.in.where2learn_new.detailspage.HobbyClassesDetailsActivity;

public class HobbyDetailsWebServiceCall {
	...
	public HobbyDetailsWebServiceCall(String classified_id) {
			...
			public void onDismiss(DialogInterface dialog) {
				...
				if (isError) {
					...
					Intent intent = new Intent(activity,
							HobbyClassesDetailsActivity.class);
