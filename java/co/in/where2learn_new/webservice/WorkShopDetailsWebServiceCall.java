...
import co.in.where2learn_new.detailspage.WorkshopDetailsActivity;

public class WorkShopDetailsWebServiceCall {
	...
	public WorkShopDetailsWebServiceCall(String classified_id) {
