...
public class CoachingWebServiceCall {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					callWebService(AppConfig.URICoachingType);
		...
		ringProgressDialog.setOnDismissListener(new OnDismissListener() {
			...
			public void onDismiss(DialogInterface dialog) {
				...
				if (isError) {
					...
					Intent intent = new Intent(activity, CoachingActivity.class);
	...
	private void initArrayList() {
		...
		boardFilter = AppConfig.CoachingFilterModel.getBoard();
		classesFilter = AppConfig.CoachingFilterModel.getClasses();
		subjectFilter = AppConfig.CoachingFilterModel.getSubject();
