...
public class SendProfessionalFiltersWebServiceCall {
	...
	private ProfessionalCourseslListActivity professionalCourseslListActivity;

	public void sendProfessionalFilters(Activity activityParam, String city,
			String areaList, String courseList) throws Exception {

		this.activity = activityParam;

		SendProfessionalFiltersWebServiceCall.city = city;
		SendProfessionalFiltersWebServiceCall.areaList = areaList;
		SendProfessionalFiltersWebServiceCall.courseList = courseList;
			...
			public void onDismiss(DialogInterface dialog) {
				...
				if (isError) {
					...
					Intent intent = new Intent(activity,
							ProfessionalCourseslListActivity.class);
...
//					activity.finish();
	...
	public synchronized void callWebService() throws Exception {
		...
		String URI = AppConfig.URI_POSTPROFESSIONALSEARCH + "?city=" + URLEncoder.encode(city, "UTF-8")
				+ "&Area=" + URLEncoder.encode(areaList, "UTF-8")
				+ "&Courses=" + URLEncoder.encode(courseList, "UTF-8")
				+ getRange();
...
//		AppConfig.CURRENTRANGE += AppConfig.LISTRANGE;
	...
	public void loadProfessionalFilters(
			ProfessionalCourseslListActivity professionalCourseslListActivityParam) {


		this.professionalCourseslListActivity = professionalCourseslListActivityParam;

		ringProgressDialog = ProgressDialog.show(professionalCourseslListActivity, "Please wait ...",
		...
		ringProgressDialog.setOnDismissListener(new OnDismissListener() {
			...
			public void onDismiss(DialogInterface dialog) {
				...
				if (isError) {
					...
					professionalCourseslListActivity.initListView();
				}
