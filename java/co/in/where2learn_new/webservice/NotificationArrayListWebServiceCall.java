...
import co.in.where2learn_new.footer.NotificationActivity;

public class NotificationArrayListWebServiceCall {
	...
	public void getNotificationArrayDetails(Activity activityParam) {
	...
	public synchronized void callWebService() throws Exception {
		...
		String URI = AppConfig.URI_NotificationDetails
				+ "?min=1&max=12&UserID=" + userID;
