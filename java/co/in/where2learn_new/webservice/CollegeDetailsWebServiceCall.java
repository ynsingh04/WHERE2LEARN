...
import co.in.where2learn_new.detailspage.CollegeDetailsActivity;

public class CollegeDetailsWebServiceCall {
	...
	public CollegeDetailsWebServiceCall(String classified_id) {
