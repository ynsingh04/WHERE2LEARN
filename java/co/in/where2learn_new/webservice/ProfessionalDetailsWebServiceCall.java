...
import co.in.where2learn_new.detailspage.ProfessionalDetailsActivity;

public class ProfessionalDetailsWebServiceCall {
	...
	public ProfessionalDetailsWebServiceCall(String classified_id) {
...
//					callImageGalleriesSearchService();
			...
			public void onDismiss(DialogInterface dialog) {
				...
				if (isError) {
					...
					Intent intent = new Intent(activity,
							ProfessionalDetailsActivity.class);
	...
	private void parseExternallinkSearchXML(Object result) throws JSONException {
		...
		for (int i = 0; i < cast.length(); i++) {
			...
			classifiedDetails.put("type" + i, type);
			classifiedDetails.put("link" + i, link);
