...
public class CollegeListActivity extends Activity {
	...
	protected void loadNext() {
		...
		filterListBusinessLogic.callNextCollegeRange(collegeListActivity);
	...
	private void initComponent() {
		...
		/*search_list_title_nameImageView.setImageDrawable(activity
				.getDrawable(R.drawable.icon_college_img));*/

		title_name.setText(activity
				.getString(R.string.college_list_classes_name));
		((ImageView)findViewById(R.id.search_list_iv_heading_text)).setBackgroundResource(R.drawable.college_icon_text);
		((ImageView)findViewById(R.id.search_list_title_nameImageView)).setImageBitmap(null);
		((ImageView)findViewById(R.id.search_list_title_nameImageView)).setBackgroundResource(R.drawable.icon_college);
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		super.onDestroy();
//		startActivity(new Intent(activity, CollegeActivity.class));
		finish();
	}
