...
public class ProfessionalCourseslListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		activity = this;
		professionalCourseslListActivity = this;
	...
	protected void loadNext() {
		...
		filterListBusinessLogic
				.callNextProfessionalRange(professionalCourseslListActivity);
	...
	private void initComponent() {
		...
		title_name.setText(activity
				.getString(R.string.professional_list_classes_name));
		((ImageView)findViewById(R.id.search_list_iv_heading_text)).setBackgroundResource(R.drawable.professional_icon_text);
		((ImageView)findViewById(R.id.search_list_title_nameImageView)).setImageBitmap(null);
		((ImageView)findViewById(R.id.search_list_title_nameImageView)).setBackgroundResource(R.drawable.icon_professional);
		...
		/*search_list_title_nameImageView.setImageDrawable(activity
				.getDrawable(R.drawable.icon_proffessional_img));*/
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		super.onDestroy();
//		startActivity(new Intent(activity, ProfessionalCourseActivity.class));
		finish();
	}
