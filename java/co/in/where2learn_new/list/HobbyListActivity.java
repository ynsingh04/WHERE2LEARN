...
public class HobbyListActivity extends Activity {
	...
	protected void loadNext() {
		...
		filterListBusinessLogic.callNextHobbyRange(hobbyListActivity);
	...
	private void initComponent() {
		...
		title_name
				.setText(activity.getString(R.string.hobby_list_classes_name));
		((ImageView)findViewById(R.id.search_list_iv_heading_text)).setBackgroundResource(R.drawable.hobby_icon_text);
		((ImageView)findViewById(R.id.search_list_title_nameImageView)).setImageBitmap(null);
		((ImageView)findViewById(R.id.search_list_title_nameImageView)).setBackgroundResource(R.drawable.icon_hobby);
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		super.onDestroy();
//		startActivity(new Intent(activity, HobbyClassesActivity.class));
		finish();
	}
