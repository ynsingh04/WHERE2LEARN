...
public class TuitionListActivity extends Activity {
	...
	protected void loadNext() {
		...
		filterListBusinessLogic.callNextTuitionRange(tuitionListActivity);
	...
	private void initComponent() {
		...
		title_name.setText(activity
				.getString(R.string.tuition_list_classes_name));
		((ImageView)findViewById(R.id.search_list_iv_heading_text)).setBackgroundResource(R.drawable.tuition_icon_text);
		((ImageView)findViewById(R.id.search_list_title_nameImageView)).setImageBitmap(null);
		((ImageView)findViewById(R.id.search_list_title_nameImageView)).setBackgroundResource(R.drawable.icon_tutor);
		...
		/*search_list_title_nameImageView.setImageDrawable(activity
				.getDrawable(R.drawable.icon_tution_img));*/
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		super.onDestroy();
//		startActivity(new Intent(activity, TutorActivity.class));
		finish();
	}
