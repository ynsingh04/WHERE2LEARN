...
public class CareerlListActivity extends Activity {
	...
	protected void loadNext() {
		...
		filterListBusinessLogic.callNextCareerRange(careerlListActivity);
	...
	private void initComponent() {
		...
		title_name.setText(activity
				.getString(R.string.carrer_list_classes_name));
		((ImageView)findViewById(R.id.search_list_iv_heading_text)).setBackgroundResource(R.drawable.career_icon_text);
		((ImageView)findViewById(R.id.search_list_title_nameImageView)).setImageBitmap(null);
		((ImageView)findViewById(R.id.search_list_title_nameImageView)).setBackgroundResource(R.drawable.icon_career);
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		super.onDestroy();	
//		startActivity(new Intent(activity, CareerActivity.class));
		finish();
	}
