...
public class SearchListListViewCustomAdapter extends BaseAdapter {
	...
	public SearchListListViewCustomAdapter(Activity context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.llContainer = (LinearLayout) convertView
					.findViewById(R.id.searchListItem_ll_container);
			...
			holder.txtViewAddress = (TextView) convertView
					.findViewById(R.id.txtViewAddress);
			holder.txtViewPhone = (TextView) convertView
					.findViewById(R.id.txtViewPhone);
			holder.txtViewDateAndTime = (TextView) convertView
					.findViewById(R.id.workshop_txtViewDate);
			holder.txtViewDisabledMessage = (TextView) convertView
					.findViewById(R.id.workshop_txtViewDisabledMessage);

			convertView.setTag(holder);
		} else
			holder = (ViewHolder) convertView.getTag();

		SearchListItemBean bean = (SearchListItemBean) itemList.get(position);
...
//		holder.imgViewLogo.setImageResource(bean.getImgViewIcon());
		...
		if(context == WorkShopListActivity.activity) {
