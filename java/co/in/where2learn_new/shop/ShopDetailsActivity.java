		...
		callOnClickListener = new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(mobilenumberTextView.getText().toString().length()>0)
					mobileNumber = mobilenumberTextView.getText().toString();
				else if(mobilenumberTwoTextView.getText().toString().length()>0)
					mobileNumber = mobilenumberTwoTextView.getText().toString();
				detailsPageBusinessLogic.invokePhoneCall(mobileNumber);
...
//				String shareBody = classifiedDetails.get("description");
				String shareBody = activity.getString(R.string.shop_details_type_shop) +
...
//				startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(contentDescription)));
	...
	private void initComponent() {
		...
		bannerImageView = (ImageView) findViewById(R.id.activity_shop_details_bannerImageView);

		backImageView = (ImageView) findViewById(R.id.shop_detailsBackImageView);
		titleTextView = (TextView) findViewById(R.id.activity_shop_details_titleTextView);
		typeTextView = (TextView) findViewById(R.id.activity_shop_details_typeTextView);
		external_link1TextView = (TextView) findViewById(R.id.activity_shop_details_external_link1TextView);
		external_link2TextView = (TextView) findViewById(R.id.activity_shop_details_external_link2TextView);

		callTextView = (TextView) findViewById(R.id.activity_shop_details_callTextView);
		mapTextView = (TextView) findViewById(R.id.activity_shop_details_mapTextView);
		shareTextView = (TextView) findViewById(R.id.activity_shop_details_shareTextView);
		ratingTextView = (TextView) findViewById(R.id.activity_shop_details_ratingTextView);
		notifyTextView = (TextView) findViewById(R.id.activity_shop_details_notifyTextView);
		displayImagesTextView = (TextView) findViewById(R.id.activity_shop_details_displayImagesTextView);

		descriptionTextView = (TextView) findViewById(R.id.activity_shop_details_descriptionTextView);
		typeTextView.setText(activity
				.getString(R.string.shop_details_type_shop));
		...
		productTextView = (TextView) findViewById(R.id.activity_shop_details_product_availableTextView);
		addressTextView = (TextView) findViewById(R.id.activity_shop_details_addressTextView);
		mobilenumberTextView = (TextView) findViewById(R.id.activity_shop_details_mobilenumberTextView);
		mobilenumberTwoTextView = (TextView) findViewById(R.id.activity_shop_details_mobilenumberTwoTextView);

		ratingRatingBar = (RatingBar) findViewById(R.id.activity_shop_details_ratingRatingBar);
		image1ImageView = (ImageView) findViewById(R.id.activity_shop_details_image1ImageView);
		image2ImageView = (ImageView) findViewById(R.id.activity_shop_details_image2ImageView);
		image3ImageView = (ImageView) findViewById(R.id.activity_shop_details_image3ImageView);
		image4ImageView = (ImageView) findViewById(R.id.activity_shop_details_image4ImageView);
		...
		productTextView.setText(classifiedDetails.get("facilitiesValue"));
