...
public class ShopListActivity extends Activity {
	...
	private void initListener() {
		...
		search_listView1Listener = new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterview, View view,
				...
				finalDetailsBusinessLogic.invokeShopDetailsPage(bean);
	...
	protected void loadNext() {
		...
		filterListBusinessLogic.callNextShopRange(shopListActivity);
	...
	private void initComponent() {
		...
		title_name.setText(activity.getString(R.string.shop));
		((ImageView)findViewById(R.id.search_list_iv_heading_text)).setBackgroundResource(R.drawable.shop_icon_text);
		((ImageView)findViewById(R.id.search_list_title_nameImageView)).setImageBitmap(null);
		((ImageView)findViewById(R.id.search_list_title_nameImageView)).setBackgroundResource(R.drawable.icon_shop);
