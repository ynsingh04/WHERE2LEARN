...
//				String shareBody = classifiedDetails.get("description");
				String shareBody = activity.getString(R.string.school_details_type_school) +
...
//				startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(contentDescription)));
	...
	private void initComponent() {
		...
		bannerImageView = (ImageView) findViewById(R.id.activity_school_details_bannerImageView);

		backImageView = (ImageView) findViewById(R.id.school_detailsBackImageView);
		titleTextView = (TextView) findViewById(R.id.activity_school_details_titleTextView);
		typeTextView = (TextView) findViewById(R.id.activity_school_details_typeTextView);
		external_link1TextView = (TextView) findViewById(R.id.activity_school_details_external_link1TextView);
		external_link2TextView = (TextView) findViewById(R.id.activity_school_details_external_link2TextView);

		callTextView = (TextView) findViewById(R.id.activity_school_details_callTextView);
		mapTextView = (TextView) findViewById(R.id.activity_school_details_mapTextView);
		shareTextView = (TextView) findViewById(R.id.activity_school_details_shareTextView);
		ratingTextView = (TextView) findViewById(R.id.activity_school_details_ratingTextView);
		notifyTextView = (TextView) findViewById(R.id.activity_school_details_notifyTextView);
		displayImagesTextView = (TextView) findViewById(R.id.activity_school_details_displayImagesTextView);

		descriptionTextView = (TextView) findViewById(R.id.activity_school_details_descriptionTextView);
		typeTextView.setText(activity
				.getString(R.string.school_details_type_school));
		...
		facilities_availableTextView = (TextView) findViewById(R.id.activity_school_details_facilities_availableTextView);
		fee_structureTextView = (TextView) findViewById(R.id.activity_school_details_fee_structureTextView);
		important_datesTextView = (TextView) findViewById(R.id.activity_school_details_important_datesTextView);
		addressTextView = (TextView) findViewById(R.id.activity_school_details_addressTextView);
		mobilenumberTextView = (TextView) findViewById(R.id.activity_school_details_mobilenumberTwoTextView);
		mobilenumberTwoTextView = (TextView) findViewById(R.id.activity_school_details_mobilenumberTextView);

		ratingRatingBar = (RatingBar) findViewById(R.id.activity_school_details_ratingRatingBar);
		image1ImageView = (ImageView) findViewById(R.id.activity_school_details_image1ImageView);
		image2ImageView = (ImageView) findViewById(R.id.activity_school_details_image2ImageView);
		image3ImageView = (ImageView) findViewById(R.id.activity_school_details_image3ImageView);
		image4ImageView = (ImageView) findViewById(R.id.activity_school_details_image4ImageView);
...
//		fee_structureTextView.setText("1-5 Rs.1500 and 6-12 Rs.4500");
		important_datesTextView.setText(classifiedDetails
				.get("important_dates"));
