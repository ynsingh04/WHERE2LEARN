...
public class HobbyClassesDetailsActivity extends Activity {
	...
	private TextView important_datesTextView;
	private TextView typeTextView;
	private TextView fee_structureTextView;
...
//				String shareBody = classifiedDetails.get("description");
				String shareBody = activity.getString(R.string.hobby_details_type_hobby) +
...
//				startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(contentDescription)));
	...
	private void initComponent() {
		...
		bannerImageView = (ImageView) findViewById(R.id.activity_hobby_details_bannerImageView);

		backImageView = (ImageView) findViewById(R.id.hobby_detailsBackImageView);
		titleTextView = (TextView) findViewById(R.id.activity_hobby_details_titleTextView);
		typeTextView = (TextView) findViewById(R.id.activity_hobby_details_typeTextView);
		external_link1TextView = (TextView) findViewById(R.id.activity_hobby_details_external_link1TextView);
		external_link2TextView = (TextView) findViewById(R.id.activity_hobby_details_external_link2TextView);

		callTextView = (TextView) findViewById(R.id.activity_hobby_details_callTextView);
		mapTextView = (TextView) findViewById(R.id.activity_hobby_details_mapTextView);
		shareTextView = (TextView) findViewById(R.id.activity_hobby_details_shareTextView);
		ratingTextView = (TextView) findViewById(R.id.activity_hobby_details_ratingTextView);
		notifyTextView = (TextView) findViewById(R.id.activity_hobby_details_notifyTextView);
		displayImagesTextView = (TextView) findViewById(R.id.activity_hobby_details_displayImagesTextView);

		descriptionTextView = (TextView) findViewById(R.id.activity_hobby_details_descriptionTextView);
		typeTextView.setText(activity
				.getString(R.string.hobby_details_type_hobby));
		...
		facilities_availableTextView = (TextView) findViewById(R.id.activity_hobby_details_facilities_availableTextView);
		fee_structureTextView = (TextView) findViewById(R.id.activity_hobby_details_fee_structureTextView);
		important_datesTextView = (TextView) findViewById(R.id.activity_hobby_details_important_datesTextView);
		addressTextView = (TextView) findViewById(R.id.activity_hobby_details_addressTextView);
		mobilenumberTextView = (TextView) findViewById(R.id.activity_hobby_details_mobilenumberTextView);
		mobilenumberTwoTextView = (TextView) findViewById(R.id.activity_hobby_details_mobilenumberTwoTextView);

		ratingRatingBar = (RatingBar) findViewById(R.id.activity_hobby_details_ratingRatingBar);
		image1ImageView = (ImageView) findViewById(R.id.activity_hobby_details_image1ImageView);
		image2ImageView = (ImageView) findViewById(R.id.activity_hobby_details_image2ImageView);
		image3ImageView = (ImageView) findViewById(R.id.activity_hobby_details_image3ImageView);
		image4ImageView = (ImageView) findViewById(R.id.activity_hobby_details_image4ImageView);
		...
		facilities_availableTextView.setText(classifiedDetails.get("facilitiesValue"));
//		fee_structureTextView.setText("1-5 Rs.1500 and 6-12 Rs.4500");
		important_datesTextView.setText("Anubhuti 2K15, 15 November");
