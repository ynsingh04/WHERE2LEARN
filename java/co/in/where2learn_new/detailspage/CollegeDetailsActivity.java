...
public class CollegeDetailsActivity extends Activity {
...
//				String shareBody = classifiedDetails.get("description");
				String shareBody = activity.getString(R.string.college_details_type_college) +
...
//				startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(contentDescription)));
	...
	private void initComponent() {
		...
		bannerImageView = (ImageView) findViewById(R.id.activity_college_details_bannerImageView);

		backImageView = (ImageView) findViewById(R.id.college_detailsBackImageView);
		titleTextView = (TextView) findViewById(R.id.activity_college_details_titleTextView);
		typeTextView = (TextView) findViewById(R.id.activity_college_details_typeTextView);
		external_link1TextView = (TextView) findViewById(R.id.activity_college_details_external_link1TextView);
		external_link2TextView = (TextView) findViewById(R.id.activity_college_details_external_link2TextView);

		callTextView = (TextView) findViewById(R.id.activity_college_details_callTextView);
		mapTextView = (TextView) findViewById(R.id.activity_college_details_mapTextView);
		shareTextView = (TextView) findViewById(R.id.activity_college_details_shareTextView);
		ratingTextView = (TextView) findViewById(R.id.activity_college_details_ratingTextView);
		notifyTextView = (TextView) findViewById(R.id.activity_college_details_notifyTextView);
		displayImagesTextView = (TextView) findViewById(R.id.activity_college_details_displayImagesTextView);

		descriptionTextView = (TextView) findViewById(R.id.activity_college_details_descriptionTextView);
		typeTextView.setText(activity
				.getString(R.string.college_details_type_college));
		...
		facilities_availableTextView = (TextView) findViewById(R.id.activity_college_details_facilities_availableTextView);
		addressTextView = (TextView) findViewById(R.id.activity_college_details_addressTextView);
		mobilenumberTextView = (TextView) findViewById(R.id.activity_college_details_mobilenumberTextView);
		mobilenumberTwoTextView = (TextView) findViewById(R.id.activity_college_details_mobilenumberTwoTextView);

		ratingRatingBar = (RatingBar) findViewById(R.id.activity_college_details_ratingRatingBar);
		image1ImageView = (ImageView) findViewById(R.id.activity_college_details_image1ImageView);
		image2ImageView = (ImageView) findViewById(R.id.activity_college_details_image2ImageView);
		image3ImageView = (ImageView) findViewById(R.id.activity_college_details_image3ImageView);
		image4ImageView = (ImageView) findViewById(R.id.activity_college_details_image4ImageView);
